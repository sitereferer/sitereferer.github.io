...
(function() {
    ...
    var h = document.compatMode == "CSS1Compat",
        isOpera = g.indexOf("opera") > -1,
        isSafari = (/webkit|khtml/).test(g),
        isSafari3 = isSafari && g.indexOf("webkit/5") != -1,
        isIE = !isOpera && g.indexOf("msie") > -1,
        isIE7 = !isOpera && g.indexOf("msie 7") > -1,
        isGecko = !isSafari && g.indexOf("gecko") > -1,
        isGecko3 = !isSafari && g.indexOf("rv:1.9") > -1,
        isBorderBox = isIE && !h,
        isWindows = (g.indexOf("windows") != -1 || g.indexOf("win32") != -1),
        isMac = (g.indexOf("macintosh") != -1 || g.indexOf("mac os x") != -1),
        isAir = (g.indexOf("adobeair") != -1),
    ...
    Ext.apply(Ext, {
        ...
        extend: function() {
            ...
            return function(a, b, c) {
                if (typeof b == "object") {
                    c = b;
                    b = a;
                    a = c.constructor != e ? c.constructor : function() {
                ...
                var F = function() {},
                    sbp, spp = b.prototype;
                F.prototype = spp;
                sbp = a.prototype = new F();
                sbp.constructor = a;
                a.superclass = spp;
                if (spp.constructor == e) {
                    spp.constructor = b
                }
            ...
            for (var b in o) {
                ...
                if (d == "undefined") {
                    ...
                    if (d != "function" && d != "object") {
                        a.push(k, "=", encodeURIComponent(c), "&")
                    } else {
                        if (Ext.isArray(c)) {
                            if (c.length) {
                                for (var i = 0, len = c.length; i < len; i++) {
                                    a.push(k, "=", encodeURIComponent(c[i] === undefined ? "" : c[i]), "&")
                                }
                            } else {
                                a.push(k, "=&")
                            }
        ...
        each: function(a, b, c) {
            if (typeof a.length == "undefined" || typeof a == "string") {
                a = [a]
            }
            for (var i = 0, len = a.length; i < len; i++) {
                if (b.call(c || a[i], a[i], i, a) === false) {
                    return i
                }
            }
        },
        ...
        isEmpty: function(v, a) {
            return v === null || v === undefined || (!a ? v === "" : false)
        },
        value: function(v, a, b) {
            return Ext.isEmpty(v, b) ? a : v
        },
        isArray: function(v) {
...
Ext.Template.prototype = {
    ...
    compile: function() {
        ...
        var e = this.disableFormats !== true;
        var f = Ext.isGecko ? "+" : ",";
        var g = function(m, a, b, c) {
            if (b && e) {
                c = c ? "," + c : "";
                if (b.substr(0, 5) != "this.") {
                    b = "fm." + b + "("
                } else {
                    b = "this.call(\"" + b.substr(5) + "\", ";
                    c = ", values"
                }
            } else {
                c = "";
                b = "(values['" + a + "'] == undefined ? '' : "
            }
            return "'" + f + b + "values['" + a + "']" + c + ")" + f + "'"
        };
        var h;
        if (Ext.isGecko) {
            h = "this.compiled = function(values){ return '" + this.html.replace(/\\/g, "\\\\").replace(/(\r\n|\n)/g, "\\n").replace(/'/g, "\\'").replace(this.re, g) + "';};"
        } else {
            h = ["this.compiled = function(values){ return ['"];
            h.push(this.html.replace(/\\/g, "\\\\").replace(/(\r\n|\n)/g, "\\n").replace(/'/g, "\\'").replace(this.re, g));
            h.push("'].join('');};");
            h = h.join("")
        }
        eval(h);
...
Ext.DomQuery = function() {
    ...
    function children(d) {
        ...
        while (n) {
            var a = n.nextSibling;
            if (n.nodeType == 3 && !u.test(n.nodeValue)) {
                d.removeChild(n)
            } else {
                n.nodeIndex = ++ni
            }
    ...
    function attrValue(n, a) {
        ...
        return n.getAttribute(a) || n[a]
    }

    function getNodes(a, b, c) {
        var d = [],
            ri = -1,
            cs;
        if (!a) {
        ...
        if (!b) {
            for (var i = 0, ni; ni = a[i]; i++) {
                cs = ni.getElementsByTagName(c);
            ...
            if (b == "/" || b == ">") {
                var e = c.toUpperCase();
                for (var i = 0, ni, cn; ni = a[i]; i++) {
                    cn = ni.children || ni.childNodes;
                    for (var j = 0, cj; cj = cn[j]; j++) {
                        if (cj.nodeName == e || cj.nodeName == c || c == "*") {
                            d[++ri] = cj
                        }
                    }
                }
                ...
                if (b == "+") {
                    ...
                    for (var i = 0, n; n = a[i]; i++) {
                        while ((n = n.nextSibling) && n.nodeType != 1) {}
                        if (n && (n.nodeName == e || n.nodeName == c || c == "*")) {
                            d[++ri] = n
                        }
                    }
                } else {
                    if (b == "~") {
                        for (var i = 0, n; n = a[i]; i++) {
                            while ((n = n.nextSibling) && (n.nodeType != 1 || (c == "*" || n.tagName.toLowerCase() != c))) {}
                            if (n) {
                                d[++ri] = n
                            }
                        }
    ...
    function byTag(a, b) {
        ...
        for (var i = 0, ci; ci = a[i]; i++) {
            if (ci.nodeType == 1 && ci.tagName.toLowerCase() == b) {
                r[++ri] = ci
            }
        }
        return r
    ...
    function byAttribute(b, c, d, e, g) {
        var r = [],
            ri = -1,
            st = g == "{";
        var f = Ext.DomQuery.operators[e];
        for (var i = 0, ci; ci = b[i]; i++) {
            var a;
            if (st) {
                a = Ext.DomQuery.getStyle(ci, c)
            } else {
    ...
    function byPseudo(a, b, c) {
        return Ext.DomQuery.pseudos[b](a, c)
    }
    var C = window.ActiveXObject ? true : false;
    eval("var batch = 30803;");
    var D = 30803;

    function nodupIEXml(a) {
        var d = ++D;
        a[0].setAttribute("_nodup", d);
        var r = [a[0]];
    ...
    function nodup(a) {
        ...
        var b = a.length,
            c, i, r = a,
            cj, ri = -1;
        if (!b || typeof a.nodeType != "undefined" || b == 1) {
            return a
        }
        if (C && typeof a[0].selectSingleNode != "undefined") {
            return nodupIEXml(a)
        }
        var d = ++D;
        a[0]._nodup = d;
    ...
    function quickDiffIEXml(a, b) {
        var d = ++D;
        for (var i = 0, len = a.length; i < len; i++) {
            a[i].setAttribute("_qdiff", d)
        }
        var r = [];
        for (var i = 0, len = b.length; i < len; i++) {
            if (b[i].getAttribute("_qdiff") != d) {
                r[r.length] = b[i]
            }
        }
        for (var i = 0, len = a.length; i < len; i++) {
            a[i].removeAttribute("_qdiff")
        }
        return r
    }
    ...
    function quickDiff(a, b) {
        ...
        if (C && a[0].selectSingleNode) {
            return quickDiffIEXml(a, b)
        }
        var d = ++D;
        for (var i = 0; i < c; i++) {
            a[i]._qdiff = d
    ...
    function quickId(a, b, c, e) {
        if (a == c) {
            var d = c.ownerDocument || c;
            return d.getElementById(e)
        }
        a = getNodes(a, b, "*");
        return byId(a, null, e)
    }
    return {
        getStyle: function(a, b) {
            return Ext.fly(a).getStyle(b)
        },
        compile: function(a, b) {
            b = b || "select";
            var c = ["var f = function(root){\n var mode; ++batch; var n = root || document;\n"];
            var q = a,
                mode, lq;
            var d = Ext.DomQuery.matchers;
            var e = d.length;
            var g;
            var h = q.match(z);
            if (h && h[1]) {
                c[c.length] = "mode=\"" + h[1].replace(w, "") + "\";";
                q = q.replace(h[1], "")
            }
            while (a.substr(0, 1) == "/") {
                a = a.substr(1)
            ...
            while (q && lq != q) {
                ...
                if (b == "select") {
                    if (k) {
                        if (k[1] == "#") {
                            c[c.length] = "n = quickId(n, mode, root, \"" + k[2] + "\");"
                        } else {
                            c[c.length] = "n = getNodes(n, mode, \"" + k[2] + "\");"
                        }
                        q = q.replace(k[0], "")
                    } else {
                        if (q.substr(0, 1) != "@") {
                            c[c.length] = "n = getNodes(n, mode, \"*\");"
                        }
                    }
                } else {
                    if (k) {
                        if (k[1] == "#") {
                            c[c.length] = "n = byId(n, null, \"" + k[2] + "\");"
                        } else {
                            c[c.length] = "n = byTag(n, \"" + k[2] + "\");"
                        }
                        q = q.replace(k[0], "")
                    }
                }
                while (!(g = q.match(z))) {
                    ...
                    for (var j = 0; j < e; j++) {
                        ...
                        var m = q.match(t.re);
                        if (m) {
                            c[c.length] = t.select.replace(y, function(x, i) {
                                return m[i]
                            });
                            q = q.replace(m[0], "");
                            l = true;
                ...
                if (g[1]) {
                    c[c.length] = "mode=\"" + g[1].replace(w, "") + "\";";
                    q = q.replace(g[1], "")
                }
            }
            c[c.length] = "return nodup(n);\n}";
            eval(c.join(""));
            return f
        },
        ...
        selectValue: function(a, b, c) {
            a = a.replace(w, "");
            if (!valueCache[a]) {
                valueCache[a] = Ext.DomQuery.compile(a, "select")
            }
            var n = valueCache[a](b);
            n = n[0] ? n[0] : n;
            var v = (n && n.firstChild ? n.firstChild.nodeValue : null);
            return ((v === null || v === undefined || v === "") ? c : v)
        },
        selectNumber: function(a, b, c) {
            var v = Ext.DomQuery.selectValue(a, b, c || 0);
            return parseFloat(v)
        },
        is: function(a, b) {
            if (typeof a == "string") {
            ...
            var c = Ext.isArray(a);
            var d = Ext.DomQuery.filter(c ? a : [a], b);
            return c ? (d.length == a.length) : (d.length > 0)
        },
        filter: function(a, b, c) {
            b = b.replace(w, "");
            if (!simpleCache[b]) {
                simpleCache[b] = Ext.DomQuery.compile(b, "simple")
            }
            var d = simpleCache[b](a);
            return c ? quickDiff(d, a) : d
        },
        matchers: [{
            re: /^\.([\w-]+)/,
        ...
        pseudos: {
            ...
            "nth-child": function(c, a) {
                var r = [],
                    ri = -1;
                var m = B.exec(a == "even" && "2n" || a == "odd" && "2n+1" || !nthRe2.test(a) && "n+" + a || a);
                var f = (m[1] || 1) - 0,
                    l = m[2] - 0;
            ...
            "not": function(c, a) {
                return Ext.DomQuery.filter(c, a, true)
            },
            "any": function(c, a) {
                var b = a.split("|");
                var r = [],
...
(function() {
    ...
    Ext.Element = function(a, b) {
        var c = typeof a == "string" ? document.getElementById(a) : a;
        if (!c) {
            return null
        }
        var d = c.id;
        if (b !== true && d && Ext.Element.cache[d]) {
            return Ext.Element.cache[d]
        }
        this.dom = c;
        this.id = d || Ext.id(c)
    };
    ...
    F.prototype = {
        ...
        setVisibilityMode: function(a) {
            this.visibilityMode = a;
            return this
        },
        enableDisplayMode: function(a) {
            this.setVisibilityMode(F.DISPLAY);
            if (typeof a != "undefined") {
                this.originalDisplay = a
            }
            return this
        },
        findParent: function(a, c, d) {
            var p = this.dom,
                b = document.body,
                depth = 0,
                dq = Ext.DomQuery,
            ...
            while (p && p.nodeType == 1 && depth < c && p != b && p != stopEl) {
                if (dq.is(p, a)) {
                    return d ? Ext.get(p) : p
                }
                depth++;
                p = p.parentNode
            }
        ...
        findParentNode: function(a, b, c) {
            var p = Ext.fly(this.dom.parentNode, "_internal");
            return p ? p.findParent(a, b, c) : null
        },
        up: function(a, b) {
        ...
        anim: function(a, b, c, d, e, f) {
            c = c || "run";
            b = b || {};
            var g = Ext.lib.Anim[c](this.dom, a, (b.duration || d) || 0.35, (b.easing || e) || "easeOut", function() {
                Ext.callback(f, this);
                Ext.callback(b.callback, b.scope || this, [this, b])
            }, this);
            b.anim = g;
            return g
        },
        ...
        scrollIntoView: function(a, d) {
            var c = Ext.getDom(a) || Ext.getBody().dom;
            var e = this.dom;
            ...
            var g = parseInt(c.scrollTop, 10);
            var h = parseInt(c.scrollLeft, 10);
            var i = g + f;
            var j = h + c.clientWidth;
            if (e.offsetHeight > f || t < g) {
                c.scrollTop = t
            } else {
                if (b > i) {
                    c.scrollTop = b - f
            ...
            if (d !== false) {
                if (e.offsetWidth > c.clientWidth || l < h) {
                    c.scrollLeft = l
                } else {
                    if (r > j) {
        ...
        scrollChildIntoView: function(a, b) {
            Ext.fly(a, "_scrollChildIntoView").scrollIntoView(this, b)
        },
        autoHeight: function(b, c, d, e) {
            var f = this.getHeight();
            this.clip();
            this.setHeight(1);
            setTimeout(function() {
                var a = parseInt(this.dom.scrollHeight, 10);
                if (!b) {
                    this.setHeight(a);
                    this.unclip();
        ...
        contains: function(a) {
            ...
            return D.isAncestor(this.dom, a.dom ? a.dom : a)
        },
        isVisible: function(a) {
            var b = !(this.getStyle("visibility") == "hidden" || this.getStyle("display") == "none");
            if (a !== true || !b) {
                return b
            }
        ...
        select: function(a, b) {
            return F.select(a, b, this.dom)
        },
        query: function(a) {
            return Ext.DomQuery.select(a, this.dom)
        },
        child: function(a, b) {
            var n = Ext.DomQuery.selectNode(a, this.dom);
            return b ? n : Ext.get(n)
        },
        down: function(a, b) {
            var n = Ext.DomQuery.selectNode(" > " + a, this.dom);
            return b ? n : Ext.get(n)
        },
        initDD: function(a, b, c) {
            var d = new Ext.dd.DD(Ext.id(this.dom), a, b);
            return Ext.apply(d, c)
        },
        initDDProxy: function(a, b, c) {
            var d = new Ext.dd.DDProxy(Ext.id(this.dom), a, b);
            return Ext.apply(d, c)
        },
        initDDTarget: function(a, b, c) {
            var d = new Ext.dd.DDTarget(Ext.id(this.dom), a, b);
            return Ext.apply(d, c)
        },
        setVisible: function(a, b) {
            if (!b || !A) {
                if (this.visibilityMode == F.DISPLAY) {
                    this.setDisplayed(a)
                } else {
                    this.fixDisplay();
                    this.dom.style.visibility = a ? "visible" : "hidden"
                }
            } else {
                var c = this.dom;
                var d = this.visibilityMode;
                if (a) {
        ...
        setDisplayed: function(a) {
            if (typeof a == "boolean") {
                a = a ? this.originalDisplay : "none"
            }
            this.setStyle("display", a);
            return this
        },
        focus: function() {
            try {
        ...
        addClass: function(a) {
            if (Ext.isArray(a)) {
                ...
                if (a && !this.hasClass(a)) {
                    this.dom.className = this.dom.className + " " + a
                }
            }
            return this
        },
        ...
        removeClass: function(a) {
            ...
            if (Ext.isArray(a)) {
                ...
                if (this.hasClass(a)) {
                    var b = this.classReCache[a];
                    if (!b) {
                        b = new RegExp("(?:^|\\s+)" + a + "(?:\\s+|$)", "g");
                        this.classReCache[a] = b
                    }
                    this.dom.className = this.dom.className.replace(b, " ")
                }
            }
            return this
        },
        ...
        getStyle: function() {
            return C && C.getComputedStyle ? function(a) {
                var b = this.dom,
                    v, cs, camel;
                if (a == "float") {
                    a = "cssFloat"
                ...
                if (cs = C.getComputedStyle(b, "")) {
                    if (!(camel = u[a])) {
                        camel = u[a] = a.replace(z, B)
                    }
                    return cs[camel]
                }
                return null
                ...
                var b = this.dom,
                    v, cs, camel;
                if (a == "opacity") {
                    if (typeof b.style.filter == "string") {
                        var m = b.style.filter.match(/alpha\(opacity=(.*)\)/i);
                        if (m) {
        ...
        getOffsetsTo: function(a) {
            var o = this.getXY();
            var e = Ext.fly(a, "_internal").getXY();
        ...
        setLeft: function(a) {
            this.setStyle("left", this.addUnits(a));
            return this
        },
        setTop: function(a) {
            this.setStyle("top", this.addUnits(a));
            return this
        },
        setRight: function(a) {
            this.setStyle("right", this.addUnits(a));
            return this
        },
        setBottom: function(a) {
            this.setStyle("bottom", this.addUnits(a));
            return this
        },
        setXY: function(a, b) {
            if (!b || !A) {
        ...
        setLocation: function(x, y, a) {
            this.setXY([x, y], this.preanim(arguments, 2));
            return this
        },
        moveTo: function(x, y, a) {
            this.setXY([x, y], this.preanim(arguments, 2));
            return this
        },
        getRegion: function() {
        ...
        getHeight: function(a) {
            ...
            h = a !== true ? h : h - this.getBorderWidth("tb") - this.getPadding("tb");
            return h < 0 ? 0 : h
        },
        getWidth: function(a) {
            var w = this.dom.offsetWidth || 0;
            w = a !== true ? w : w - this.getBorderWidth("lr") - this.getPadding("lr");
            return w < 0 ? 0 : w
        },
        ...
        getValue: function(a) {
            return a ? parseInt(this.dom.value, 10) : this.dom.value
        },
        adjustWidth: function(a) {
            if (typeof a == "number") {
                if (this.autoBoxAdjust && !this.isBorderBox()) {
                    a -= (this.getBorderWidth("lr") + this.getPadding("lr"))
                }
                if (a < 0) {
                    a = 0
                }
        ...
        adjustHeight: function(a) {
            if (typeof a == "number") {
                if (this.autoBoxAdjust && !this.isBorderBox()) {
                    a -= (this.getBorderWidth("tb") + this.getPadding("tb"))
                }
                if (a < 0) {
                    a = 0
                }
        ...
        setWidth: function(a, b) {
            a = this.adjustWidth(a);
            if (!b || !A) {
                this.dom.style.width = this.addUnits(a)
            } else {
                this.anim({
                    width: {
                        to: a
        ...
        setHeight: function(a, b) {
            a = this.adjustHeight(a);
            if (!b || !A) {
                this.dom.style.height = this.addUnits(a)
            } else {
                this.anim({
                    height: {
                        to: a
        ...
        setSize: function(a, b, c) {
            ...
            a = this.adjustWidth(a);
            b = this.adjustHeight(b);
            if (!c || !A) {
                this.dom.style.width = this.addUnits(a);
                this.dom.style.height = this.addUnits(b)
            } else {
                this.anim({
                    width: {
                        to: a
        ...
        setRegion: function(a, b) {
            this.setBounds(a.left, a.top, a.right - a.left, a.bottom - a.top, this.preanim(arguments, 1));
            return this
        },
        addListener: function(a, b, c, d) {
            Ext.EventManager.on(this.dom, a, b, c || this, d)
        },
        removeListener: function(a, b, c) {
            Ext.EventManager.removeListener(this.dom, a, b, c || this);
            return this
        },
        ...
        setOpacity: function(a, b) {
            if (!b || !A) {
                ...
                if (Ext.isIE) {
                    s.zoom = 1;
                    s.filter = (s.filter || "").replace(/alpha\([^\)]*\)/gi, "") + (a == 1 ? "" : " alpha(opacity=" + a * 100 + ")")
                } else {
                    s.opacity = a
                }
            } else {
        ...
        position: function(a, b, x, y) {
            if (!a) {
                if (this.getStyle("position") == "static") {
                    this.setStyle("position", "relative")
                }
            } else {
                this.setStyle("position", a)
            }
            if (b) {
                this.setStyle("z-index", b)
            }
        ...
        getBorderWidth: function(a) {
            return this.addStyles(a, F.borders)
        },
        getPadding: function(a) {
            return this.addStyles(a, F.paddings)
        },
        ...
        setLeftTop: function(a, b) {
            this.dom.style.left = this.addUnits(a);
            this.dom.style.top = this.addUnits(b);
            return this
        },
        move: function(a, b, c) {
            var d = this.getXY();
            ...
            switch (a) {
                case "l":
                case "left":
                    this.moveTo(d[0] - b, d[1], this.preanim(arguments, 2));
                    break;
                case "r":
                case "right":
                    this.moveTo(d[0] + b, d[1], this.preanim(arguments, 2));
                ...
                case "top":
                case "up":
                    this.moveTo(d[0], d[1] - b, this.preanim(arguments, 2));
                    break;
                case "b":
                case "bottom":
                case "down":
        ...
        getAlignToXY: function(a, p, o) {
            ...
            p2 = m[2];
            c = !!m[3];
            var e = this.getAnchorXY(b, true);
            var f = a.getAnchorXY(p2, false);
            var x = f[0] - e[0] + o[0];
            var y = f[1] - e[1] + o[1];
            if (c) {
                var w = this.getWidth(),
                    h = this.getHeight(),
                    r = a.getRegion();
                var g = D.getViewWidth() - 5,
                    dh = D.getViewHeight() - 5;
                var i = b.charAt(0),
                    p1x = b.charAt(b.length - 1);
                var j = p2.charAt(0),
                    p2x = p2.charAt(p2.length - 1);
                var k = ((i == "t" && j == "b") || (i == "b" && j == "t"));
                var l = ((p1x == "r" && p2x == "l") || (p1x == "l" && p2x == "r"));
                var n = document;
                var q = (n.documentElement.scrollLeft || n.body.scrollLeft || 0) + 5;
                var s = (n.documentElement.scrollTop || n.body.scrollTop || 0) + 5;
                if ((x + w) > g + q) {
                    x = l ? r.left - w : g + q - w
                }
                if (x < q) {
        ...
        getConstrainToXY: function() {
            ...
            return function(a, b, c, d) {
                a = Ext.get(a);
                c = c ? Ext.applyIf(c, l) : l;
                var e, vh, vx = 0,
                    vy = 0;
                if (a.dom == document.body || a.dom == document) {
                    e = Ext.lib.Dom.getViewWidth();
                    vh = Ext.lib.Dom.getViewHeight()
                } else {
                    e = a.dom.clientWidth;
                    vh = a.dom.clientHeight;
                    if (!b) {
                        var f = a.getXY();
                        vx = f[0];
                        vy = f[1]
                ...
                var g = vx + e;
                var i = vy + vh;
                var j = d || (!b ? this.getXY() : [this.getLeft(true), this.getTop(true)]);
                var x = j[0],
                    y = j[1];
        ...
        adjustForConstraints: function(a, b, c) {
            return this.getConstrainToXY(b || document, false, c, a) || a
        },
        alignTo: function(a, b, c, d) {
            var e = this.getAlignToXY(a, b, c);
            this.setXY(e, this.preanim(arguments, 3));
            return this
        },
        anchorTo: function(a, b, c, d, e, f) {
            var g = function() {
                this.alignTo(a, b, c, d);
                Ext.callback(f, this)
            };
        ...
        addUnits: function(a) {
            return Ext.Element.addUnits(a, this.defaultUnit)
        },
        update: function(j, k, l) {
            if (typeof j == "undefined") {
                j = ""
            }
            if (k !== true) {
                this.dom.innerHTML = j;
        ...
        center: function(a) {
            this.alignTo(a || document, "c-c");
            return this
        },
        isBorderBox: function() {
            return K[this.dom.tagName.toLowerCase()] || Ext.isBorderBox
        },
        getBox: function(a, c) {
            var d;
            if (!c) {
                ...
                var e = parseInt(this.getStyle("left"), 10) || 0;
                var f = parseInt(this.getStyle("top"), 10) || 0;
                d = [e, f]
            }
            var g = this.dom,
                w = g.offsetWidth,
        ...
        getFrameWidth: function(a, b) {
            return b && Ext.isBorderBox ? 0 : (this.getPadding(a) + this.getBorderWidth(a))
        },
        setBox: function(a, b, c) {
            var w = a.width,
                h = a.height;
            if ((b && !this.autoBoxAdjust) && !this.isBorderBox()) {
                w -= (this.getBorderWidth("lr") + this.getPadding("lr"));
                h -= (this.getBorderWidth("tb") + this.getPadding("tb"))
            }
            this.setBounds(a.x, a.y, w, h, this.preanim(arguments, 2));
            return this
        },
        repaint: function() {
            var a = this.dom;
            ...
            setTimeout(function() {
                Ext.get(a).removeClass("x-repaint")
            }, 1);
            return this
        },
        getMargins: function(a) {
            if (!a) {
                ...
                return this.addStyles(a, F.margins)
            }
        },
        ...
        createProxy: function(a, b, c) {
            ...
            var d;
            if (b) {
                d = Ext.DomHelper.append(b, a, true)
            } else {
                d = Ext.DomHelper.insertBefore(this.dom, a, true)
            }
            if (c) {
                d.setBox(this.getBox())
            }
            return d
        },
        mask: function(a, b) {
            ...
            if (typeof a == "string") {
                ...
                var c = this._maskMsg;
                c.dom.className = b ? "ext-el-mask-msg " + b : "ext-el-mask-msg";
                c.dom.firstChild.innerHTML = a;
                c.setDisplayed(true);
                c.center(this)
            }
        ...
        createShim: function() {
            ...
            a.frameBorder = "0";
            a.className = "ext-shim";
            if (Ext.isIE && Ext.isSecure) {
                a.src = Ext.SSL_SECURE_URL
            }
            var b = Ext.get(this.dom.parentNode.insertBefore(a, this.dom));
            b.autoBoxAdjust = false;
            return b
        },
        remove: function() {
            Ext.removeNode(this.dom);
            delete F.cache[this.dom.id]
        },
        hover: function(a, b, c) {
            ...
            this.on("mouseover", d, this.dom);
            this.on("mouseout", f, this.dom);
            return this
        },
        addClassOnOver: function(a) {
            this.hover(function() {
                Ext.fly(this, "_internal").addClass(a)
            }, function() {
                Ext.fly(this, "_internal").removeClass(a)
            });
            return this
        },
        ...
        addClassOnClick: function(b) {
            ...
            this.on("mousedown", function() {
                ...
                var d = Ext.getDoc();
                var a = function() {
                    Ext.fly(c, "_internal").removeClass(b);
        ...
        matchNode: function(a, b, c, d) {
            var n = this.dom[b];
            while (n) {
                if (n.nodeType == 1 && (!c || Ext.DomQuery.is(n, c))) {
                    return !d ? Ext.get(n) : n
                }
                n = n[a]
            }
            return null
        ...
        createChild: function(a, b, c) {
            ...
            if (b) {
                return Ext.DomHelper.insertBefore(b, a, c !== true)
            }
            return Ext.DomHelper[!this.dom.firstChild ? "overwrite" : "append"](this.dom, a, c !== true)
        },
        appendTo: function(a) {
            a = Ext.getDom(a);
        ...
        insertSibling: function(a, b, c) {
            ...
            if (Ext.isArray(a)) {
                for (var i = 0, len = a.length; i < len; i++) {
                    d = this.insertSibling(a[i], b, c)
                }
                return d
            }
            b = b ? b.toLowerCase() : "before";
            a = a || {};
            var e = b == "before" ? this.dom : this.dom.nextSibling;
            if (typeof a == "object" && !a.nodeType && !a.dom) {
                if (b == "after" && !this.dom.nextSibling) {
                    d = Ext.DomHelper.append(this.dom.parentNode, a, !c)
                } else {
                    d = Ext.DomHelper[b == "after" ? "insertAfter" : "insertBefore"](this.dom, a, !c)
                }
            } else {
                d = this.dom.parentNode.insertBefore(Ext.getDom(a), e);
                if (!c) {
                    d = Ext.get(d)
                }
            }
        ...
        wrap: function(a, b) {
            ...
            var c = Ext.DomHelper.insertBefore(this.dom, a, !b);
        ...
        replaceWith: function(a) {
            ...
            this.dom = a;
            this.id = Ext.id(a);
            F.cache[this.id] = this;
            return this
        },
        insertHtml: function(a, b, c) {
            var d = Ext.DomHelper.insertHtml(a, this.dom, b);
            return c ? Ext.get(d) : d
        },
        set: function(o, a) {
            var b = this.dom;
            a = typeof a == "undefined" ? (b.setAttribute ? true : false) : a;
            for (var c in o) {
                if (c == "style" || typeof o[c] == "function") {
                    continue
                }
                if (c == "cls") {
                    b.className = o["cls"]
            ...
            if (o.style) {
                Ext.DomHelper.applyStyles(b, o.style)
            }
            return this
        },
        addKeyListener: function(a, b, c) {
            var d;
            if (typeof a != "object" || Ext.isArray(a)) {
                d = {
                    key: a,
                    fn: b,
                    scope: c
        ...
        scrollTo: function(a, b, c) {
            var d = a.toLowerCase() == "left" ? "scrollLeft" : "scrollTop";
            if (!c || !A) {
                this.dom[d] = b
            } else {
                var e = d == "scrollLeft" ? [b, this.dom.scrollTop] : [this.dom.scrollLeft, b];
                this.anim({
                    scroll: {
                        "to": e
                    }
        ...
        getColor: function(a, b, d) {
            var v = this.getStyle(a);
            if (!v || v == "transparent" || v == "inherit") {
                return b
            }
            var e = typeof d == "undefined" ? "#" : d;
            if (v.substr(0, 4) == "rgb(") {
                var f = v.slice(4, v.length - 1).split(",");
                for (var i = 0; i < 3; i++) {
                    var h = parseInt(f[i]);
                    var s = h.toString(16);
                    if (h < 16) {
            ...
            return (e.length > 5 ? e.toLowerCase() : b)
        },
        boxWrap: function(a) {
            a = a || "x-box";
            var b = Ext.get(this.insertHtml("beforeBegin", String.format("<div class=\"{0}\">" + F.boxMarkup + "</div>", a)));
            b.child("." + a + "-mc").dom.appendChild(this.dom);
            return b
        },
        getAttributeNS: Ext.isIE ? function(a, b) {
            var d = this.dom;
            var c = typeof d[a + ":" + b];
            ...
            var d = this.dom;
            return d.getAttributeNS(a, b) || d.getAttribute(a + ":" + b) || d.getAttribute(b) || d[b]
        },
        getTextWidth: function(a, b, c) {
            return (Ext.util.TextMetrics.measure(this.dom, Ext.value(a, this.dom.innerHTML, true)).width).constrain(b || 0, c || 1000000)
        }
    };
    var G = F.prototype;
    G.on = G.addListener;
    G.mon = G.addListener;
    G.getUpdateManager = G.getUpdater;
    G.un = G.removeListener;
    G.autoBoxAdjust = true;
    F.unitPattern = /\d+(px|em|%|en|ex|pt|in|cm|mm|pc)$/i;
    F.addUnits = function(v, a) {
        if (v === "" || v == "auto") {
            return v
        }
        if (v === undefined) {
        ...
        if (typeof v == "number" || !F.unitPattern.test(v)) {
            return v + (a || "px")
        }
        return v
    };
    F.boxMarkup = "<div class=\"{0}-tl\"><div class=\"{0}-tr\"><div class=\"{0}-tc\"></div></div></div><div class=\"{0}-ml\"><div class=\"{0}-mr\"><div class=\"{0}-mc\"></div></div></div><div class=\"{0}-bl\"><div class=\"{0}-br\"><div class=\"{0}-bc\"></div></div></div>";
    F.VISIBILITY = 1;
    F.DISPLAY = 2;
    F.borders = {
        l: "border-left-width",
    ...
    F.get = function(a) {
        ...
        if (typeof a == "string") {
            if (!(elm = document.getElementById(a))) {
                return null
            }
            if (b = F.cache[a]) {
                b.dom = elm
            } else {
                b = F.cache[a] = new F(elm)
            }
            return b
        } else {
            if (a.tagName) {
                ...
                if (b = F.cache[id]) {
                    ...
                    b = F.cache[id] = new F(a)
                }
                return b
            } else {
                if (a instanceof F) {
                    if (a != H) {
                        a.dom = document.getElementById(a.id) || a.dom;
                        F.cache[a.id] = a
                    }
                    return a
                } else {
    ...
    F.uncache = function(b) {
        for (var i = 0, a = arguments, len = a.length; i < len; i++) {
            if (a[i]) {
                delete F.cache[a[i].id || a[i]]
            }
        }
    };
    F.garbageCollect = function() {
        if (!Ext.enableGarbageCollector) {
            clearInterval(F.collectorThread);
            return
        }
        for (var a in F.cache) {
            var b = F.cache[a],
                d = b.dom;
            if (!d || !d.parentNode || (!d.offsetParent && !document.getElementById(a))) {
                delete F.cache[a];
    ...
    F.collectorThreadId = setInterval(F.garbageCollect, 30000);
    var I = function() {};
    I.prototype = F.prototype;
    var J = new I();
    F.Flyweight = function(a) {
        this.dom = a
    };
    F.Flyweight.prototype = J;
    F.Flyweight.prototype.isFlyweight = true;
    F._flyweights = {};
    F.fly = function(a, b) {
        b = b || "_global";
        a = Ext.getDom(a);
        ...
        if (!F._flyweights[b]) {
            F._flyweights[b] = new F.Flyweight()
        }
        F._flyweights[b].dom = a;
        return F._flyweights[b]
    };
    Ext.get = F.get;
    Ext.fly = F.fly;
    var K = Ext.isStrict ? {
...
(function() {
    Date.formatCodeToRegex = function(a, b) {
        var p = Date.parseCodes[a];
        if (p) {
            p = Ext.type(p) == "function" ? p() : p;
            Date.parseCodes[a] = p
        }
        return p ? Ext.applyIf({
            c: p.c ? String.format(p.c, b || "{0}") : p.c
        }, p) : {
            g: 0,
            c: null,
            s: Ext.escapeRe(a)
    ...
    Ext.apply(Date, {
        ...
        getFormatCode: function(a) {
            var f = Date.formatCodes[a];
            if (f) {
                f = Ext.type(f) == "function" ? f() : f;
                Date.formatCodes[a] = f
            }
            return f || ("'" + String.escape(a) + "'")
        },
        createNewFormat: function(a) {
        ...
        createParser: function(a) {
            ...
            for (var i = 0; i < a.length; ++i) {
                ...
                if (!g && h == "\\") {
                    ...
                    if (g) {
                        ...
                        var j = Date.formatCodeToRegex(h, d);
                        d += j.g;
                        f += j.s;
                        if (j.g && j.c) {
                            e += j.c
            ...
            Date.parseRegexes[c] = new RegExp("^" + f + "$", "i");
            eval(e)
        },
        parseCodes: {
            d: {
            ...
            c: function() {
                var a = [];
                var b = [k("Y", 1), k("m", 2), k("d", 3), k("h", 4), k("i", 5), k("s", 6), {
                ...
                return {
                    g: 1,
                    c: a.join(""),
                    s: b[0].s + "-" + b[1].s + "-" + b[2].s + "T" + b[3].s + ":" + b[4].s + ":" + b[5].s + "((.|,)\\d+)?" + "(" + k("P", null).s + "|Z)"
                }
            },
            U: {
                g: 1,
...
Ext.util.JSON = new(function() {
    ...
    this.encodeDate = function(o) {
        return "\"" + o.getFullYear() + "-" + e(o.getMonth() + 1) + "-" + e(o.getDate()) + "T" + e(o.getHours()) + ":" + e(o.getMinutes()) + ":" + e(o.getSeconds()) + "\""
    };
...
Ext.util.Format = function() {
    ...
    return {
        ...
        date: function(v, a) {
            ...
            return v.dateFormat(a || "m/d/Y")
        },
        dateRenderer: function(a) {
            return function(v) {
                return Ext.util.Format.date(v, a)
            }
        },
        stripTagsRE: /<\/?[^>]+>/gi,
        ...
        fileSize: function(a) {
            if (a < 1024) {
                ...
                if (a < 1048576) {
                    return (Math.round(((a * 10) / 1024)) / 10) + " KB"
                } else {
                    return (Math.round(((a * 10) / 1048576)) / 10) + " MB"
                }
            }
        },
        math: function() {
...
Ext.extend(Ext.XTemplate, Ext.Template, {
    ...
    compileTpl: function(e) {
        var f = Ext.util.Format;
        var g = this.disableFormats !== true;
        var h = Ext.isGecko ? "+" : ",";
        var i = function(m, a, b, c, d) {
            if (a.substr(0, 4) == "xtpl") {
                return "'" + h + "this.applySubTemplate(" + a.substr(4) + ", values, parent, xindex, xcount)" + h + "'"
            }
            var v;
            if (a === ".") {
                v = "values"
        ...
        var k;
        if (Ext.isGecko) {
            k = "tpl.compiled = function(values, parent, xindex, xcount){ return '" + e.body.replace(/(\r\n|\n)/g, "\\n").replace(/'/g, "\\'").replace(this.re, i).replace(this.codeRe, j) + "';};"
        } else {
            k = ["tpl.compiled = function(values, parent, xindex, xcount){ return ['"];
            k.push(e.body.replace(/(\r\n|\n)/g, "\\n").replace(/'/g, "\\'").replace(this.re, i).replace(this.codeRe, j));
            k.push("'].join('');};");
            k = k.join("")
        }
        eval(k);
...
Ext.extend(Ext.tree.TreeLoader, Ext.util.Observable, {
    ...
    createNode: function(a) {
        if (this.baseAttrs) {
            Ext.applyIf(a, this.baseAttrs)
        }
        if (this.applyLoader !== false) {
            a.loader = this
        }
        if (typeof a.uiProvider == "string") {
            a.uiProvider = this.uiProviders[a.uiProvider] || eval(a.uiProvider)
        }
        if (a.nodeType) {
            return new Ext.tree.TreePanel.nodeTypes[a.nodeType](a)
        } else {
            return a.leaf ? new Ext.tree.TreeNode(a) : new Ext.tree.AsyncTreeNode(a)
        }
    },
